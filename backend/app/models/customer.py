...
class Customer(Base):
    ...
    calendar_account_email = Column(String, nullable=True)
    calendar_access_token_encrypted = Column(String, nullable=True)
    calendar_refresh_token_encrypted = Column(String, nullable=True)
