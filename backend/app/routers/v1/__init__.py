...
router.include_router(customer_router.router)          # /customers/me, /customers/events/*, etc.
...
# planning_router retired: POST /planning/generate merged into
# POST /customers/events/{eventId}/chat (see customer_router.py)
