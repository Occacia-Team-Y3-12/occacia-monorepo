...
down_revision: str | Sequence[str] | None = "4de2b30ff548"
...
def upgrade() -> None:
    op.add_column(
        "recommendation_packages", sa.Column("base_package_id", sa.String(), nullable=True)
    )
    op.add_column(
        "recommendation_packages", sa.Column("created_by_customer_id", sa.String(), nullable=True)
    )
