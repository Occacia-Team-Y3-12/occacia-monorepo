...
def upgrade() -> None:
    ...
    op.add_column("customers", sa.Column("calendar_access_token_encrypted", sa.String(), nullable=True))
    op.add_column("customers", sa.Column("calendar_refresh_token_encrypted", sa.String(), nullable=True))
    op.add_column("customers", sa.Column("calendar_token_expires_at", sa.DateTime(timezone=True), nullable=True))
